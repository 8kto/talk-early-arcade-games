...
With some short time, this led to the company developing their **own games**.

<img 
  src="./src/slides/images/3--periscope-i.jpg" 
...
Now let's step back a bit and take a look at the first video games ever.


## First video games
<img 
  src="./src/slides/images/5--bertie.jpg" 
...
<img 
  style="max-width:1000px" 
  src="./src/slides/images/5--PDP-1.jpg" 
  alt="PDP-1 computer" 
/>

_Spacewar!_ is a space combat video game developed in 1962 by Steve Russell in collaboration with Martin Graetz and Wayne Wiitanen, 
...
[![Spacewar! 1962](http://img.youtube.com/vi/7bzWnaH-0sg/0.jpg)](https://www.youtube.com/watch?v=7bzWnaH-0sg)

Game was written in almost a half of year. While the game was officially banned at some installations 
(e.g. BBN outlawed _Spacewar!_ occasionally, mainly because of dying control switches), it was also the most important showcase for the PDP-1. 
Eventually PDP-1s shipped with a copy of _Spacewar!_ in memory for testing purpose. 
(Since the machine's magnetic core memory was persistent, the program would be present, when the machine was unpacked and switched on — ready for a test run of _Spacewar!_ 
...
### First arcades
First arcade galleries were full of simple mechanical games like pinball and other primitive machines. 
...
<img 
  src="./src/slides/images/6--Nolan_Bushnell_2013.jpg" 
  alt="Nolan Bushnell" 
/>

In the late 1960s, Nolan Bushnell saw _Spacewar!_ running on a mainframe at the University of Utah where he was a student.
...
and when he saw _Spacewar!_ he believed that an arcade game version of the game would be very popular.
...
<img 
  src="./src/slides/images/6--Data_General_NOVA_System.jpg" 
...
Dabney remained at Ampex until the summer, when he resigned to join Bushnell at Nutting, as he was initially unwilling to leave the stable job he had worked at for ten years without more proof that the game could be a success.

<img 
  src="./src/slides/images/7--computer-space-ii.jpg" 
...
> Computer Space is a derivative of the 1962 computer game _Spacewar!_, possibly the first video game to spread to multiple computer installations. 
...
By May 1972, Bushnell and Dabney quit Nutting Associates and moved to incorporate Syzygy Engineering; they instead named it Atari due to another company with a similar name.
 Bushnell later stated that he was encouraged by the success of Computer Space in regards to future game ideas, as he had never before created something that made so much money, and additionally felt that his time at Nutting gave him confidence in running his own company because he "couldn't screw it up more than they did".
 
Bushnell's enthusiasm was soon vindicated, as Atari's first game, Pong, went on to substantially greater success than Computer Space. Although not as influential as Pong, Computer Space's release marked the **beginning of the commercial video game industry**.
